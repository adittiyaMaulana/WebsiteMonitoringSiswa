...
<div class="my-content">
    ...
    <div class="navbar_pilihan mt-5 ml-4">
        <ul>
            <li><a class="active" href="/admin/jadwalKelasSiswa">Akademik</a></li>
            <li><a href="/admin/jadwalNonAkademikSiswa">Non Akademik</a></li>
        </ul>
    </div>
    ...
    <div class="isi_konten">
        ...
        <div class="button_area ml-2 mb-4">
            <a href="/admin/formKelasSiswa"><button type="button" class="btn btn-success">Tambah Data<i class="bi bi-plus ml-2"></i></button></a>
        </div>
