...
<div class="my-content">
    ...
    <div class="navbar_pilihan ml-2 mt-5">
        <ul>
            <li><a href="/orangTua/jadwalKelas">Pelajaran</a></li>
            <li><a class="active" href="/orangTua/jadwalAkadanNonAkademik">Kalender Akademik</a></li>
        </ul>
    </div>
    ...
    <div class="tabel mt-5 ml-4 mr-4">
        ...
        <table id="tableOrtu" class="table table-hover" style="width:100%">
...
<script>
    $(document).ready(function() {
        $('#periode').on('change', function(e) {
            ...
            $.get('{{ url("orangTua/filterJadwalAkaNonAka")}}/' + id, function(data) {
                console.log(id);
                console.log(data);
